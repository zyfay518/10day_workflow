    ...
    return (
        <div className={cn(
            ...
            <div className="flex flex-col items-center">
                <div className="w-20 h-20 rounded-[24px] bg-gradient-to-br from-[#849B87] to-[#A3B8A6] flex items-center justify-center shadow-xl shadow-[#849B87]/20 mb-6 relative animate-pulse-slow">
